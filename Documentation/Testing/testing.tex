...
\pagebreak
	...
	\begin{center}
	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrCRUD/tests-pass.png.png}
	\end{figure}
	\end{center}
	...
	\begin{center}
	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrCRUD/tests-fail.png}
	\end{figure}
	\end{center}
	...
	\begin{center}
	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrUI/TestAge.JPG}
	\end{figure}

	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrUI/TestLogin.JPG}
	\end{figure}

	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrUI/TestLoginFunction.JPG}
	\end{figure}

	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrUI/TestRegister.JPG}
	\end{figure}

	\begin{figure}[h]
		\includegraphics[width=15cm, height=13cm]{usrUI/TestUsername.JPG}
	\end{figure}
	\end{center}
