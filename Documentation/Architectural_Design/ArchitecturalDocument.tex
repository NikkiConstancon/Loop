...
\edef\input@path{{./DataCollection/}{./Introduction/}{./DataStorage/}{./OverallDescription/}{./UserInterface/}{./StatisticsSubsystem/}\input@path}% prepend
\makeatother
...
\section{Detailed Artifact Descriptions}
	...
	\subsection{Cloud Server Environment}
		...
		\subsubsection{Data Storage}
			...
			\input{DataStorage.tex}
			
		\newpage
		\subsubsection{Statistics}
			\input{statisticsSubsystem.tex}
